...
-- Fri 22 Nov 2019 11:41:33 AM EST
...
CREATE TABLE IF NOT EXISTS `cenozo`.`application` (
  ...
  `release_event_type_id` INT UNSIGNED NULL,
  `country` VARCHAR(45) NOT NULL,
  `timezone` VARCHAR(45) NOT NULL DEFAULT 'Canada/Eastern',
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenozo`.`opal_form_template` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenozo`.`supporting_script_check` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenozo`.`role_has_consent_type` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenozo`.`role_has_proxy_type` ;
...
-- -----------------------------------------------------
-- Table `application`.`setting`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `application`.`setting` ;

CREATE TABLE IF NOT EXISTS `application`.`setting` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `site_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `application`.`access` ;

CREATE TABLE IF NOT EXISTS `application`.`access` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `user_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `application`.`recording`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `application`.`recording` ;

CREATE TABLE IF NOT EXISTS `application`.`recording` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `rank` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `application`.`recording_file`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `application`.`recording_file` ;

CREATE TABLE IF NOT EXISTS `application`.`recording_file` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  ...
  CONSTRAINT `fk_recording_file_recording_id`
    ...
    REFERENCES `application`.`recording` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
